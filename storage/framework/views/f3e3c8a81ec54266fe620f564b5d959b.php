...
<?php $__env->startSection('custom_js'); ?>
    <script>
        ...
        function get_task() {
            ...
            $.ajax({
                url: "<?php echo e(url('api/get-task/')); ?>",
                type: "GET",
        ...
        function get_emplyee(emplyee_id=null) {
            ...
            $.ajax({
                url: "<?php echo e(url('api/get-emplyee/')); ?>",
                type: "GET",
                error: function(a, b, c) {
        ...
        function add_task(){
            ...
            $.ajax({
                url: "<?php echo e(url('api/add-task/')); ?>",
                type: "POST",
                data:  formData,
                error: function(a, b, c) {
        ...
        function delete_task(task_id){
            ...
            if(confirm("Do You want to delete?")){
                $.ajax({
                    url: "<?php echo e(url('api/delete-task/')); ?>",
                    type: "POST",
                    data: {
        ...
        function edit_task(task_id){
            var token = localStorage.getItem("token");
            $.ajax({
                url: "<?php echo e(url('api/get-single-task')); ?>/"+task_id,
                type: "GET",
                error: function(a, b, c) {
        ...
        function update_task(){
            ...
            const formData = $('#add_task_form').serialize();
            $.ajax({
                url: "<?php echo e(url('api/edit-task/')); ?>",
                type: "POST",
                data:  formData,
                error: function(a, b, c) {
...
<?php echo $__env->make('admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\papiy\OneDrive\Documents\ecotance\task_test\resources\views/dashboard.blade.php ENDPATH**/ ?>