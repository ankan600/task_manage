            ...
            <div class="col-xl-6">
                <div class="card-body p-md-5 p-sm-5 p-4 mx-md-4 mx-sm-3">
                    <div class="text-center">
                        <h4 class=" heading mt-1  pb-1">{{ request()->is('/') ? 'User Login' : 'Admin Login' }}</h4>
                    </div>
                    ...
                    <div class="text-right {{ request()->is('/') ? '' : 'hidden' }}">
                        <a href="{{url('reg')}}"><p class="mt-1 pb-1">{{ request()->is('/') ? 'Register' : '' }}</p></a>
                    </div>
                </div>
