            ...
            <div class="left_bar">
                <div class="menu p-2">
                    <ul class="nav nav-pills flex-column mb-auto">
                        <li class="nav-item">
                            <a href="{{url('/dashboard')}}" class="nav-link link-light {{ request()->is('dashboard') ? 'active' : '' }}" aria-current="page">
                        ...
                        <li>
                            <a href="{{url('/emplyee-list')}}" class="nav-link link-light {{ request()->is('emplyee-list') ? 'active' : '' }}">
                                <svg class="bi me-2" width="16" height="16">
