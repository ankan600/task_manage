                            ...
                            <div class="col-12">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between">
                                        <p>DataTables</p>
                                        {{-- <span><button type="button"class="btn btn-primary" id="show_add_task_modal"> <i class="bi bi-plus"></i></button></span> --}}
                                    </div>
                                    <div class="card-body">
                                        <script>
                                            $('#example').DataTable();
...
function change_task_status(checkbox) {
    ...
    var token = localStorage.getItem("token");
            ...
            $.ajax({
                url: "{{ url('api/change-task-status/') }}",
                type: "POST",
                data:  {
                    "_token": "{{ csrf_token() }}",
                    "task_id":task_id,
